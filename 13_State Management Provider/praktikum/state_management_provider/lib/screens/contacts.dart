...
class _ContactsPageState extends State<ContactsPage> {
  ...
  void handleSubmit(List contacts, {int index = -1}) {
  ...
  void editContact(int i, List contacts) {
  ...
  void deleteContact(int i, List contacts) {
    setState(() {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ListView(
        children: <Widget>[
          contactHero(context),
          contactForm(context, contactProvider.contacts),
          contactList(context, contactProvider.contacts),
        ],
      ),
    );
  }
  ...
  Widget contactForm(BuildContext context, List contacts) {
  ...
  Widget contactList(BuildContext context, List contacts) {
    return Column(
      children: <Widget>[
        const Text(
          "List Contacts",
                    ...
                    children: <Widget>[
                      ...
                      Row(
                        children: <Widget>[
                          IconButton(
                            onPressed: () =>
                                handleSubmit(contacts, index: index),
                            icon: const Icon(Icons.edit_outlined),
                          ),
                          IconButton(
                            onPressed: () => deleteContact(index, contacts),
